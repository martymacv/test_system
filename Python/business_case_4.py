...
# мне нужно в цикле запросить данные о доходах по всему списку статей, если ничего не вводится, то ничего и не вносится
sql_text = f"select id, article from archive.articles"
